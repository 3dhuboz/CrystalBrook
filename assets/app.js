...
const PRODUCTS = [
  ...
  { id:'p-snap',     name:'Pink Snapper',         cat:'saltwater', price:455, size:'64 × 32 cm', pimg:'snap',      image:IMG+'snapper.png',   badge:null,         meta:'Reef · Spotted Gum mount',              desc:'Classic pink snapper with iridescent blue spots and that proud humped forehead. ' + STD_DESC },
  ...
  { id:'p-sail',     name:'Sailfish',             cat:'saltwater', price:740, size:'130 × 38 cm',pimg:'sail',      image:IMG+'mahi.png',      badge:'Signature',  meta:'Billfish · Ironbark mount',             desc:'Iridescent sailfish with full sail raised — the speedster of the blue water. ' + STD_DESC },
  ...
  { id:'p-yellowfin',name:'Yellowfin Tuna',       cat:'saltwater', price:660, size:'104 × 36 cm',pimg:'yellowfin', image:IMG+'mahi.png',      badge:null,         meta:'Blue-water · Ironbark mount',           desc:'Deep blue back with electric-yellow finlets — the offshore prize. ' + STD_DESC },
