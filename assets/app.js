...
const PRODUCTS = [
  ...
  { id:'p-marlin',   name:'Black Marlin',         cat:'saltwater', price:760, size:'120 × 40 cm',pimg:'marlin',    image:IMG+'black-marlin.png', badge:'Signature',  meta:'Billfish · Ironbark mount',             desc:'Trophy-size black marlin in full striking pose — vertical stripes, sail-set dorsal, the apex pelagic. ' + STD_DESC },
  { id:'p-mahi',     name:'Mahi Mahi (Dorado)',   cat:'saltwater', price:560, size:'90 × 34 cm', pimg:'mahi',      image:IMG+'mahi-mahi.png', badge:null,         meta:'Pelagic · Blackwood mount',             desc:'Electric-blue back fading to gold-and-spots flank — the dorado in its first-out-of-the-water colours. ' + STD_DESC },
  { id:'p-snapper',  name:'Red Emperor Snapper',  cat:'saltwater', price:425, size:'60 × 36 cm', pimg:'snapper',   image:IMG+'red-emperor.png',   badge:null,         meta:'Reef · Silky Oak mount',                desc:'Deep-reef red emperor with fin detail and subtle scale texture. ' + STD_DESC,
    gallery: [
      { src: IMG+'red-emperor.png',      alt:'Red Emperor · single', label:'Solo' },
      { src: IMG+'red-emperor-pair.png', alt:'Red Emperor · pair',   label:'Pair' },
    ]
  },
  { id:'p-gt',       name:'Giant Trevally',       cat:'saltwater', price:510, size:'78 × 38 cm', pimg:'gt',        image:IMG+'giant-trevally.png', badge:null,         meta:'Tropical reef · Ironbark mount',        desc:'The bruiser of the flats — silver flank with electric-blue dorsal, built to hang large. ' + STD_DESC },
  { id:'p-mackerel', name:'Spanish Mackerel',     cat:'saltwater', price:535, size:'100 × 30 cm',pimg:'mackerel',  image:IMG+'spanish-mackerel.png', badge:null,    meta:'Pelagic · Blackwood mount',             desc:'Vivid blue-and-silver Spanish mackerel with electric tiger striping — a sleek pelagic predator caught mid-cruise. ' + STD_DESC },
  { id:'p-mangrove', name:'Mangrove Jack',        cat:'saltwater', price:475, size:'62 × 30 cm', pimg:'mangrove',  image:IMG+'mangrove-jack.png', badge:null,         meta:'NQ estuary · River Red Gum mount',      desc:'Crimson-red mangrove jack — hard-fighting estuary brawler with that signature toothy underbite. ' + STD_DESC },
  ...
  { id:'p-mulloway', name:'Mulloway (Jewfish)',   cat:'saltwater', price:540, size:'90 × 32 cm', pimg:'mulloway',  image:IMG+'mulloway.png',  badge:null,         meta:'Surf · Blackwood mount',                desc:'Silver-flanked mulloway with that signature dark dorsal — the holy grail of Aussie surf and estuary fishers. ' + STD_DESC },
  ...
  { id:'p-tusk',     name:'Black Spot Tusk Fish', cat:'saltwater', price:495, size:'62 × 30 cm', pimg:'tusk',      image:IMG+'tusk-fish.png', badge:null,         meta:'Reef · Silky Oak mount',                desc:'Vibrant green tusk fish with iconic black flank spot — a reef showstopper. ' + STD_DESC },
  ...
  { id:'p-wahoo',    name:'Wahoo',                cat:'saltwater', price:580, size:'108 × 28 cm',pimg:'wahoo',     image:IMG+'wahoo.png',     badge:null,         meta:'Pelagic · Spotted Gum mount',           desc:'Slate-blue wahoo with vivid tiger stripes — the speed-demon of the open ocean. ' + STD_DESC },
  ...
  { id:'p-finger',   name:'Fingermark',           cat:'saltwater', price:455, size:'58 × 30 cm', pimg:'finger',    image:IMG+'snapper.png',   badge:null,         meta:'Tropical reef · River Red Gum mount',   desc:'Coppery-pink fingermark with that telltale dark shoulder spot. ' + STD_DESC, draft:true  },
  { id:'p-longtail', name:'Longtail Tuna',        cat:'saltwater', price:585, size:'94 × 32 cm', pimg:'longtail',  image:IMG+'mahi.png',      badge:null,         meta:'Pelagic · Blackwood mount',             desc:'Northern bluefin / longtail tuna — Aussie surface-feeder royalty. ' + STD_DESC, draft:true  },
  { id:'p-yellowfin',name:'Yellowfin Tuna',       cat:'saltwater', price:660, size:'104 × 36 cm',pimg:'yellowfin', image:IMG+'yellowfin-tuna.png', badge:null,        meta:'Blue-water · Ironbark mount',           desc:'Electric blue stripe along the back, golden lateral band, sickle-yellow finlets — the offshore prize. ' + STD_DESC },
  { id:'p-bluefin',  name:'Southern Bluefin Tuna',cat:'saltwater', price:720, size:'110 × 40 cm',pimg:'bluefin',   image:IMG+'mahi.png',      badge:'Signature',  meta:'Southern ocean · Ironbark mount',       desc:'Southern bluefin — the cold-water heavyweight of Aussie blue-water fishing. ' + STD_DESC, draft:true  },
  { id:'p-ruby',     name:'Rubyfish',             cat:'saltwater', price:445, size:'56 × 28 cm', pimg:'ruby',      image:IMG+'snapper.png',   badge:'New',        meta:'Deep reef · River Red Gum mount',       desc:'Vivid ruby-red flank — a striking deep-water reef catch. ' + STD_DESC, draft:true  },
  { id:'p-bonito',   name:'Bonito',               cat:'saltwater', price:445, size:'66 × 28 cm', pimg:'bonito',    image:IMG+'bonito.png',    badge:'New',        meta:'Pelagic · Spotted Gum mount',           desc:'Striped bonito — slim, fast, the saltwater equivalent of the river blackfish. ' + STD_DESC },
  /* ------- Saltwater additions from Max's photo set (Apr 2026) ------- */
  { id:'p-coral-hunter', name:'Coral Trout · Hunter',  cat:'saltwater', price:520, size:'70 × 34 cm', pimg:'coral-hunter', image:IMG+'coral-trout-hunter.png', badge:'New',        meta:'GBR · Spotted Gum mount',              desc:'Painted-style coral trout in attack pose — deeper crimson, dramatic dark fins. ' + STD_DESC },
  { id:'p-estuary',  name:'Estuary Cod',          cat:'saltwater', price:495, size:'80 × 38 cm', pimg:'estuary',   image:IMG+'estuary-cod.png',           badge:'New',        meta:'Mangrove + reef · River Red Gum mount', desc:'Mottled brown estuary cod speckled with cream — solid mangrove brawler. ' + STD_DESC },
  { id:'p-cobia',    name:'Cobia',                cat:'saltwater', price:545, size:'92 × 32 cm', pimg:'cobia',     image:IMG+'cobia.png',                 badge:'New',        meta:'Pelagic · Blackwood mount',             desc:'Sleek silver cobia with dark lateral stripe and saw-tooth dorsal — the offshore speedster. ' + STD_DESC },
  { id:'p-whaleshark', name:'Whale Shark',        cat:'saltwater', price:780, size:'140 × 42 cm',pimg:'whaleshark',image:IMG+'whale-shark.png',            badge:'Signature',  meta:'Ningaloo Reef · Ironbark mount',        desc:"World's largest fish — distinctive grid of white spots on slate-blue. " + STD_DESC },
  { id:'p-whaleshark-aerial', name:'Whale Shark · Aerial', cat:'saltwater', price:680, size:'120 × 50 cm', pimg:'whaleshark-aerial', image:IMG+'whale-shark-aerial.png', badge:'New',  meta:'Ningaloo Reef · Spotted Gum mount', desc:'Top-down view — captures the full breadth of the spotted dorsal pattern. ' + STD_DESC },
  { id:'p-emperor',  name:'Spangled Emperor',     cat:'saltwater', price:495, size:'74 × 36 cm', pimg:'emperor',   image:IMG+'spangled-emperor.png',      badge:'New',        meta:'Reef · Silky Oak mount',                desc:'Iridescent blue scales over a golden body — Top End reef trophy. ' + STD_DESC,
    gallery: [
      { src: IMG+'spangled-emperor.png',     alt:'Spangled Emperor · classic',  label:'Classic' },
      { src: IMG+'spangled-emperor-alt.png', alt:'Spangled Emperor · variant',  label:'Variant' },
    ]
  },
  { id:'p-banded',   name:'Black Cod (Banded)',   cat:'saltwater', price:535, size:'82 × 36 cm', pimg:'banded',    image:IMG+'black-cod-banded.png',      badge:'New',        meta:'Inshore reef · Spotted Gum mount',      desc:'Iconic banded eastern black cod — bold cream stripes on dark brown, every scale picked out. ' + STD_DESC },
  { id:'p-flathead', name:'Dusky Flathead',       cat:'saltwater', price:425, size:'82 × 28 cm', pimg:'flathead',  image:IMG+'dusky-flathead.png',        badge:'New',        meta:'Estuary · Spotted Gum mount',           desc:'Camouflage-mottled dusky flathead with that broad fan-like pectoral — the iconic estuary ambush predator. ' + STD_DESC },
  ...
  { id:'p-mandarin', name:'Mandarinfish',         cat:'saltwater', price:485, size:'48 × 36 cm', pimg:'mandarin',  image:IMG+'mandarin-fish.png',  badge:'New',        meta:'Tropical reef · Silky Oak mount',       desc:'A psychedelic riot of orange, blue and yellow — one of the most ornately patterned fish in tropical waters. ' + STD_DESC },
  { id:'p-wrasse',   name:'Maori Wrasse',         cat:'saltwater', price:625, size:'94 × 50 cm', pimg:'wrasse',    image:IMG+'maori-wrasse.png',   badge:'Signature',  meta:'GBR icon · Ironbark mount',             desc:"The Napoleon wrasse — humped forehead, brain-coral cheek pattern, electric turquoise scales. A reef heavyweight. " + STD_DESC,
    gallery: [
      { src: IMG+'maori-wrasse.png',     alt:'Maori Wrasse · profile',  label:'Profile' },
      { src: IMG+'maori-wrasse-alt.png', alt:'Maori Wrasse · close',    label:'Close' },
    ]
  },
  { id:'p-redthroat',name:'Red Throat Emperor',   cat:'saltwater', price:465, size:'68 × 32 cm', pimg:'redthroat', image:IMG+'red-throat-emperor.png', badge:'New',    meta:'WA reef · Silky Oak mount',             desc:'Honeycomb-scaled emperor with vivid crimson fins and lips — the WA reef showpiece. ' + STD_DESC },
  { id:'p-redbass',  name:'Red Bass',             cat:'saltwater', price:495, size:'70 × 36 cm', pimg:'redbass',   image:IMG+'red-bass.png',       badge:'New',        meta:'Tropical reef · River Red Gum mount',   desc:'Deep-crimson Red Bass — solidly built reef brawler with a bulldog jaw. ' + STD_DESC },
  { id:'p-golden-trev', name:'Golden Trevally',   cat:'saltwater', price:495, size:'72 × 36 cm', pimg:'golden-trev', image:IMG+'golden-trevally.png', badge:'New',     meta:'Tropical · Silky Oak mount',            desc:'Yellow-bodied Golden Trevally with the trademark dark flank spots — a Top End estuary regular. ' + STD_DESC },
  { id:'p-russells', name:"Russell's Snapper · Pair", cat:'saltwater', price:545, size:'80 × 50 cm', pimg:'russells', image:IMG+'russells-snapper-pair.png', badge:'New', meta:'Reef · Silky Oak mount',           desc:"A pair of Russell's Snappers — silver-and-yellow flank with the trademark mid-flank black spot. Two fish, one piece. " + STD_DESC },

  /* ------- FRESHWATER FISH ------- */
  { id:'p-barra',    name:'Barramundi',           cat:'freshwater',price:495, size:'72 × 30 cm', pimg:'barra',     image:IMG+'barramundi.png', badge:null,         meta:'Top End river · Spotted Gum mount',     desc:'Classic Aussie barramundi, silver-green flank catching the light. ' + STD_DESC,
    gallery: [
      { src: IMG+'barramundi.png',       alt:'Barramundi · classic silver',  label:'Silver' },
      { src: IMG+'barramundi-vivid.png', alt:'Barramundi · vivid teal',      label:'Vivid' },
    ]
  },
  { id:'p-cod',      name:'Murray Cod',           cat:'freshwater',price:540, size:'82 × 36 cm', pimg:'cod',       image:IMG+'murray-cod.png', badge:'Bestseller', meta:'Murray-Darling · River Red Gum mount',  desc:'The river king — heavily mottled olive-and-black flank, signature wide mouth, every scale rendered in archival ink. ' + STD_DESC },
  { id:'p-yellowb',  name:'Golden Perch · Yellowbelly', cat:'freshwater', price:445, size:'56 × 28 cm', pimg:'yellowbelly', image:IMG+'yellowbelly.png',    badge:null,         meta:'Inland rivers · Spotted Gum mount',     desc:'Warm copper and gold — a classic Murray-Darling target. ' + STD_DESC },
  { id:'p-bass',     name:'Australian Bass',      cat:'freshwater',price:425, size:'50 × 26 cm', pimg:'bass',      image:IMG+'australian-bass.png', badge:null,         meta:'East-coast streams · Blackwood mount',  desc:'Native Australian bass in striking pose — dark dorsal fin raised, jaws agape. ' + STD_DESC },
  { id:'p-toga',     name:'Saratoga',             cat:'freshwater',price:515, size:'70 × 28 cm', pimg:'toga',      image:IMG+'saratoga.png',  badge:'New',        meta:'NQ billabong · River Red Gum mount',    desc:'Prehistoric northern saratoga with iridescent gold-green scales and chin barbels. ' + STD_DESC },
  { id:'p-trout',    name:'Brown Trout',          cat:'freshwater',price:445, size:'58 × 28 cm', pimg:'trout',     image:IMG+'brown-trout.png', badge:null,         meta:'High-country streams · Blackwood mount',  desc:'Olive-flanked brown trout speckled with red and black — the high-country classic. ' + STD_DESC },
  { id:'p-rainbow',  name:'Rainbow Trout',        cat:'freshwater',price:445, size:'58 × 28 cm', pimg:'rainbow',   image:IMG+'rainbow-trout.png', badge:null,         meta:'Cold-water streams · Spotted Gum mount', desc:"Silver flank lit by a vivid pink lateral band — a fly-fisher's favourite. " + STD_DESC },
  { id:'p-redfin',   name:'Redfin Perch',         cat:'freshwater',price:415, size:'52 × 26 cm', pimg:'redfin',    image:IMG+'barra.png',     badge:null,         meta:'Inland lakes · River Red Gum mount',     desc:'Olive-green flank with bold dark stripes and unmistakable red fins. ' + STD_DESC, draft:true  },
  { id:'p-jungle',   name:'Jungle Perch',         cat:'freshwater',price:435, size:'54 × 26 cm', pimg:'jungle',    image:IMG+'coral-alt.png', badge:'New',        meta:'NQ forest streams · Silky Oak mount',    desc:'Silver-bodied jungle perch with red-tinged fins — a clear-water tropical native. ' + STD_DESC, draft:true  },
  { id:'p-tilapia',  name:'Mozambique Tilapia',   cat:'freshwater',price:395, size:'50 × 26 cm', pimg:'tilapia',   image:IMG+'tilapia.png',       badge:null,         meta:'Tropical river · Blackwood mount',       desc:'Dark iridescent cichlid with rose-edged tail — a stand-out trophy from northern waters. ' + STD_DESC },
  { id:'p-sooty',    name:'Sooty Grunter',        cat:'freshwater',price:425, size:'52 × 26 cm', pimg:'sooty',     image:IMG+'sooty-grunter.png', badge:'New',        meta:'Tropical highland streams · Ironbark mount', desc:'Silvery sooty grunter with dark wedge tail tips — brawler of the tropical headwaters. ' + STD_DESC },

  /* ------- CARS ------- */
  /* Aussie muscle */
  { id:'p-mustang',  name:'1971 Mach-1 Mustang',  cat:'cars',      price:625, size:'88 × 34 cm', pimg:'mustang',   image:IMG+'mach-1-mustang.png', badge:null,         meta:'American muscle · Blackwood mount',     desc:'Yellow Mach-1 in profile with Magnum 500 wheels and Mach-1 side stripe — the classic muscle-era silhouette. ' + STD_DESC },
  { id:'p-monaro',   name:'HQ Monaro GTS',        cat:'cars',      price:640, size:'88 × 34 cm', pimg:'monaro',    image:IMG+'hq-monaro-blue.png', badge:'Signature',  meta:'Aussie muscle · Blackwood mount',       desc:'Electric-blue HQ GTS with white twin-stripe and Magnum 500 wheels — peak Aussie muscle. ' + STD_DESC,
    gallery: [
      { src: IMG+'hq-monaro-blue.png',  alt:'HQ Monaro GTS · electric blue', label:'Blue' },
      { src: IMG+'hq-monaro-green.png', alt:'HQ Monaro GTS · lime green',    label:'Green' },
      { src: IMG+'hq-monaro-pink.png',  alt:'HQ Monaro GTS · pink one-off',  label:'Pink' },
    ]
  },
  { id:'p-torana',   name:'LX Torana SL/R 5000',  cat:'cars',      price:650, size:'88 × 32 cm', pimg:'torana',    image:IMG+'torana-slr-5000.png', badge:null,         meta:'Holden muscle · Spotted Gum mount',     desc:'Red LX Torana SL/R 5000 with the bonnet-scoop stance and flared arches — Bathurst-era Aussie muscle. ' + STD_DESC },
  { id:'p-xu1',      name:'LJ Torana XU-1',       cat:'cars',      price:660, size:'86 × 34 cm', pimg:'xu1',       image:IMG+'torana-xu1.png',  badge:'Signature',  meta:'Holden muscle · Spotted Gum mount',     desc:'Orange LJ Torana XU-1 with black bonnet stripe — Brock\'s weapon of choice. ' + STD_DESC },
  { id:'p-a9x',      name:'A9X Torana SS',        cat:'cars',      price:685, size:'92 × 36 cm', pimg:'a9x',       image:IMG+'torana-a9x.png',  badge:'Signature',  meta:'Holden muscle · Ironbark mount',        desc:'Orange A9X Torana SS — flared arches, blackout bonnet, the ultimate Bathurst-era Holden. ' + STD_DESC },
  ...
  { id:'p-xy-ute',   name:'XY Falcon GT Ute',     cat:'cars',      price:640, size:'94 × 32 cm', pimg:'xy-ute',    image:IMG+'xy-falcon-gt-ute.png', badge:'New',  meta:'Ford ute · River Red Gum mount',        desc:'Red XY Falcon GT 351 ute with twin black bonnet stripes and gold side flash — work week, race weekend. ' + STD_DESC },
  { id:'p-gtho',     name:'XY Falcon GT-HO Phase 3', cat:'cars',   price:695, size:'94 × 34 cm', pimg:'gtho',      image:IMG+'falcon-gtho.png', badge:'Signature',  meta:'Ford GT-HO · Ironbark mount',           desc:'Red XY GT-HO Phase 3 sedan — the holy grail of Aussie muscle. Side stripes, bonnet pins, the lot. ' + STD_DESC },
  { id:'p-cobra',    name:'XB Falcon Cobra',      cat:'cars',      price:660, size:'92 × 32 cm', pimg:'cobra',     image:IMG+'falcon-cobra.png', badge:'New',       meta:'Ford coupe · Spotted Gum mount',        desc:'Sky-blue XB Falcon Cobra coupe — bonnet scoop, white stripes, that low-slung 70s coupe stance. ' + STD_DESC },
  /* Valiant Charger family */
  { id:'p-charger-vh', name:'VH Valiant Charger',  cat:'cars',     price:625, size:'88 × 32 cm', pimg:'charger-vh', image:IMG+'valiant-charger-vh-blue.png', badge:'New', meta:'Aussie Mopar · Blackwood mount',     desc:'Hemi-orange VH Valiant Charger — the original "Hey Charger!" Available in two factory colours. ' + STD_DESC,
    gallery: [
      { src: IMG+'valiant-charger-vh-blue.png',  alt:'VH Valiant Charger · blue',  label:'Blue'  },
      { src: IMG+'valiant-charger-vh-green.png', alt:'VH Valiant Charger · green', label:'Green' },
    ]
  },
  { id:'p-charger-rt', name:'VE Valiant Charger R/T', cat:'cars',  price:640, size:'88 × 32 cm', pimg:'charger-rt', image:IMG+'valiant-charger-rt.png', badge:'New',     meta:'Aussie Mopar · Spotted Gum mount',  desc:'Vivid orange VE Valiant Charger R/T — the earlier-generation Mopar coupe with the four-headlight grille. ' + STD_DESC },
  /* Holden utes + wagons */
  { id:'p-sandman',  name:'HZ Sandman Panel Van', cat:'cars',      price:625, size:'94 × 36 cm', pimg:'sandman',   image:IMG+'sandman-panel-van.png', badge:'New',  meta:'Holden van · River Red Gum mount',      desc:'Blue 1975 HZ Holden Sandman with sunset side flash — the surfer-coast cult classic. ' + STD_DESC },
  { id:'p-vs-ute',   name:'VS Holden Ute',        cat:'cars',      price:585, size:'94 × 30 cm', pimg:'vs-ute',    image:IMG+'vs-commodore-ute.png', badge:'New',   meta:'Holden ute · Spotted Gum mount',        desc:'White VS Commodore ute, side profile — the workhorse that defined the 90s tradie. ' + STD_DESC },
  /* American */
  { id:'p-camaro',   name:'1969 Camaro SS 396',   cat:'cars',      price:680, size:'92 × 34 cm', pimg:'camaro',    image:IMG+'camaro-ss.png', badge:'New',           meta:'American muscle · Blackwood mount',     desc:'Red 1969 Camaro SS 396 — split bumper, cowl-induction hood, the original GM pony car. ' + STD_DESC },
  { id:'p-bronco',   name:'Ford Bronco',          cat:'cars',      price:625, size:'82 × 56 cm', pimg:'bronco',    image:IMG+'ford-bronco.png', badge:'New',         meta:'4WD classic · Ironbark mount',          desc:'Blue first-gen Ford Bronco with white roof — the original boxy go-anywhere classic. ' + STD_DESC },
  { id:'p-corvette', name:'Corvette C8 Stingray', cat:'cars',      price:680, size:'96 × 30 cm', pimg:'corvette',  image:IMG+'corvette-c8.png', badge:'New',         meta:'American sports · Blackwood mount',     desc:'Red mid-engine C8 Corvette Stingray, side profile — Detroit\'s answer to Maranello. ' + STD_DESC },
  { id:'p-delorean', name:'DeLorean DMC-12',      cat:'cars',      price:660, size:'92 × 30 cm', pimg:'delorean',  image:IMG+'delorean.png', badge:'New',            meta:'80s classic · Spotted Gum mount',       desc:'Red DeLorean DMC-12 — gullwing icon, no flux capacitor included. ' + STD_DESC },
  { id:'p-mustang-iridescent', name:'Modern Mustang · Custom Wrap', cat:'cars', price:725, size:'94 × 34 cm', pimg:'mustang-irid', image:IMG+'mustang-iridescent.png', badge:'New', meta:'Show-car · Blackwood mount',  desc:'Modern Mustang in iridescent gold-pink chrome wrap — for the show-car crowd. ' + STD_DESC },
  /* British */
  { id:'p-mini',     name:'Classic Mini Cooper',  cat:'cars',      price:545, size:'70 × 38 cm', pimg:'mini',      image:IMG+'mini-cooper-classic.png', badge:'New', meta:'British classic · Blackwood mount',     desc:'British Racing Green classic Mini with white roof and Union Jack badge — the original. ' + STD_DESC },
  { id:'p-mini-modern', name:'Mini Cooper · Modern', cat:'cars',   price:545, size:'72 × 38 cm', pimg:'mini-modern', image:IMG+'mini-cooper-modern.png', badge:'New', meta:'BMW Mini · Blackwood mount',         desc:'Cherry-red modern BMW Mini Cooper with white bonnet stripes — the reboot done right. ' + STD_DESC },
  { id:'p-mg-midget', name:'1979 MG Midget',      cat:'cars',      price:585, size:'80 × 32 cm', pimg:'mg-midget', image:IMG+'mg-midget.png', badge:'New',           meta:'British convertible · Blackwood mount', desc:'Red 1979 MG Midget convertible — classic British roadster proportions, top-down. ' + STD_DESC },
  { id:'p-jag-etype', name:'Jaguar E-Type',       cat:'cars',      price:725, size:'100 × 30 cm', pimg:'e-type',   image:IMG+'jaguar-e-type.png', badge:'Signature', meta:'British icon · Spotted Gum mount',     desc:'British Racing Green Jaguar E-Type coupe — Enzo Ferrari called it "the most beautiful car ever made." ' + STD_DESC },
  { id:'p-aston-db7', name:'Aston Martin DB7',    cat:'cars',      price:680, size:'94 × 32 cm', pimg:'db7',       image:IMG+'aston-martin-db7.png', badge:'New',    meta:'British GT · Blackwood mount',          desc:'Red Aston Martin DB7 — the GT that put Aston back on the map in the 90s. ' + STD_DESC },
  { id:'p-sierra',   name:'Ford Sierra RS',       cat:'cars',      price:545, size:'82 × 36 cm', pimg:'sierra',    image:IMG+'ford-sierra.png', badge:'New',         meta:'80s European · Blackwood mount',        desc:'Blue Ford Sierra — the rep-mobile that ruled European motorways and rally stages alike. ' + STD_DESC },
  /* European utility */
  { id:'p-kombi',    name:'VW Kombi · Samba',     cat:'cars',      price:595, size:'80 × 50 cm', pimg:'kombi',     image:IMG+'vw-kombi.png',  badge:'New',          meta:'Iconic van · Spotted Gum mount',        desc:'Yellow-and-white 1965 VW Kombi 23-window Samba bus — peace, surfboards and panel-van memories. ' + STD_DESC },
  /* Japanese classics */
  { id:'p-datsun-180b', name:'Datsun 180B',       cat:'cars',      price:555, size:'88 × 30 cm', pimg:'datsun-180', image:IMG+'datsun-180b.png', badge:'New',        meta:'70s coupe · Blackwood mount',           desc:'Blue Datsun 180B coupe — the import that quietly outsold half of Detroit through the mid-70s. ' + STD_DESC },
  { id:'p-datsun-240k', name:'Datsun 240K GL',    cat:'cars',      price:565, size:'88 × 30 cm', pimg:'datsun-240', image:IMG+'datsun-240k.png', badge:'New',        meta:'Skyline lineage · Blackwood mount',     desc:'Red Datsun 240K GL coupe — the Australian-market Skyline-lineage coupe that earned its cult following. ' + STD_DESC },

  /* ------- ANIMALS ------- */
  { id:'p-frenchie', name:'French Bulldog Puppy', cat:'animals',   price:425, size:'54 × 72 cm', pimg:'frenchie',  image:IMG+'french-bulldog.png',  badge:'Bestseller', meta:'Pet portrait · Spotted Gum mount',      desc:'Cream Frenchie puppy, wide-eyed and upright. ' + STD_DESC },
  { id:'p-heeler',   name:'Blue Heeler',          cat:'animals',   price:465, size:'60 × 74 cm', pimg:'heeler',    image:IMG+'frenchie.png',  badge:null,         meta:'Working dog · Ironbark mount',          desc:'The quintessential Aussie working dog, blue-merle coat and alert eyes. ' + STD_DESC, draft:true  },
  { id:'p-kanga',    name:'Red Kangaroo',         cat:'animals',   price:520, size:'80 × 96 cm', pimg:'kanga',     image:IMG+'red-kangaroo.png',  badge:null,         meta:'Aussie icon · Spotted Gum mount',       desc:'Standing red kangaroo — capturing the powerful hind legs and alert ears. ' + STD_DESC },
  { id:'p-koala',    name:'Koala',                cat:'animals',   price:445, size:'56 × 70 cm', pimg:'koala',     image:IMG+'koala.png',     badge:null,         meta:'Marsupial · Blackwood mount',           desc:'Classic tree-cuddle koala pose, silver-grey fur clinging to a eucalyptus branch. ' + STD_DESC },
  { id:'p-dingo',    name:'Dingo',                cat:'animals',   price:495, size:'72 × 54 cm', pimg:'dingo',     image:IMG+'frenchie.png',  badge:null,         meta:'Wild dog · Ironbark mount',             desc:'Golden-coated dingo in a watchful side profile. ' + STD_DESC, draft:true  },
  { id:'p-turtle',   name:'Green Sea Turtle',     cat:'animals',   price:550, size:'72 × 56 cm', pimg:'turtle',    image:IMG+'sea-turtle.png', badge:'New',  meta:'Reef dweller · Silky Oak mount',        desc:'Green sea turtle in full glide — sun-burst shell pattern, intricate flipper scaling. ' + STD_DESC },
  { id:'p-ulysses',  name:'Ulysses Butterfly',    cat:'animals',   price:305, size:'40 × 38 cm', pimg:'ulysses',   image:IMG+'ulysses-butterfly.png', badge:'New', meta:'Tropical Queensland · Silky Oak mount', desc:'Electric-blue Ulysses butterfly — a Far North Queensland icon. ' + STD_DESC },
  /* ------- Animals additions from Max's photo set (Apr 25) ------- */
  ...
  { id:'p-mudcrab',  name:'Mud Crab',             cat:'animals',   price:395, size:'56 × 38 cm', pimg:'mudcrab',   image:IMG+'mud-crab.png',   badge:'New',        meta:'NQ mangrove · River Red Gum mount',     desc:'Olive-green Top End mudcrab, claws raised — the muddies that fishers chase up the creek every wet season. ' + STD_DESC },
  { id:'p-dolphin',  name:'Bottlenose Dolphin',   cat:'animals',   price:545, size:'92 × 38 cm', pimg:'dolphin',   image:IMG+'dolphin.png',    badge:'New',        meta:'Coastal · Spotted Gum mount',           desc:'Bottlenose dolphin in mid-glide — gunmetal-grey back fading to silver belly, every fluke detail intact. ' + STD_DESC },

  /* ------- BIRDS ------- */
  { id:'p-lorikeet', name:'Rainbow Lorikeet',     cat:'birds',     price:385, size:'50 × 60 cm', pimg:'lorikeet',  image:IMG+'rainbow-lorikeet.png',  badge:'Popular',    meta:'Aussie parrot · Silky Oak mount',       desc:'Electric rainbow plumage — blue head, lime-green wings, fiery orange chest. ' + STD_DESC },
  { id:'p-kooka',    name:'Kookaburra',           cat:'birds',     price:395, size:'54 × 60 cm', pimg:'kooka',     image:IMG+'kookaburra.png', badge:null,         meta:'Laughing bird · Spotted Gum mount',     desc:'Classic laughing kookaburra — dark eye-mask, dagger beak and the signature pale-blue flash on the wing. ' + STD_DESC },
  { id:'p-cocky',    name:'Sulphur-Crested Cockatoo', cat:'birds', price:420, size:'58 × 68 cm', pimg:'cocky',     image:IMG+'sulphur-crested-cockatoo.png', badge:null,         meta:'Parrot · Blackwood mount',              desc:'Cheeky cockatoo with crest raised — pure white body, sulphur-yellow crest. ' + STD_DESC },
  { id:'p-eagle',    name:'Wedge-Tailed Eagle',   cat:'birds',     price:620, size:'110 × 74 cm',pimg:'eagle',     image:IMG+'wedge-tailed-eagle.png', badge:'Signature',  meta:'Raptor · Ironbark mount',               desc:"Australia's largest raptor — golden ruff, dark wedge-shaped tail, predator's gaze. " + STD_DESC },
  { id:'p-galah',    name:'Galah',                cat:'birds',     price:375, size:'50 × 56 cm', pimg:'galah',     image:IMG+'galah.png', badge:null,         meta:'Pink parrot · Silky Oak mount',         desc:'Soft pink chest, silver-grey wings and a pale rose crest — always a favourite. ' + STD_DESC },
  ...
  { id:'p-montage-aus-sportfish', name:'Australian Sport-Fish Map', cat:'montages',
    ...
    image: IMG+'montage-australia-rivers.png',
    ...
    gallery: [
      { src: IMG+'montage-australia-rivers.png', alt:'Australia map with labelled rivers', label:'Rivers' },
...
const CAT_IMAGES = {
  ...
  'montages':   'assets/images/products/montage-australia-rivers.png',
...
/* SHOP = the customer-facing catalogue. Drops products tagged
   draft:true (those that don't have their own real photo yet —
   they'd otherwise show as duplicates of another product).
   Use SHOP for everything customer-facing. PRODUCTS is still used
   for cart/wishlist lookups so a draft can't break a saved item. */
const SHOP = PRODUCTS.filter(p => !p.draft);
...
function renderCategoryShowcase(){
  ...
  showcase.innerHTML = SHOWCASE.map(c => {
    const inCat = SHOP.filter(p => p.cat === c.cat);
...
function renderGrid(catOrList='all', { flip = false } = {}){
  ...
  const list = Array.isArray(catOrList)
    ? catOrList.filter(p => !p.draft)
    : (catOrList === 'all' ? SHOP : SHOP.filter(p => p.cat === catOrList));
...
(() => {
  ...
  const tabCounts = { all: SHOP.length };
  for (const cat of validCats) {
    if (cat === 'all') continue;
    tabCounts[cat] = SHOP.filter(p => p.cat === cat).length;
  }
  tabs.querySelectorAll('.cat-tab').forEach(tab => {
    const cat = tab.dataset.cat;
    const badge = tab.querySelector('.cat-tab-count');
    if (badge && cat in tabCounts) badge.textContent = tabCounts[cat];
  });
  // Also patch the hero stat counters (#30 pieces) on shop.html if present
  document.querySelectorAll('[data-shop-stat]').forEach(el => {
    if (el.dataset.shopStat === 'total') el.textContent = SHOP.length;
  });
...
(() => {
  ...
  function buildList(){
    ...
    let list = cat === 'all' ? SHOP.slice() : SHOP.filter(p => p.cat === cat);
    if (state.price){
...
(() => {
  ...
  const pool = SHOP.filter(p => p.image);
  const featured = [
...
(() => {
  ...
  if (relatedGrid){
    const related = SHOP.filter(p => p.cat === product.cat && p.id !== product.id).slice(0, 4);
    if (!related.length){
