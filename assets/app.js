...
const PRODUCTS = [
  ...
  { id:'p-tilapia',  name:'Mozambique Tilapia',   cat:'freshwater',price:395, size:'50 × 26 cm', pimg:'tilapia',   image:IMG+'cod.png',       badge:null,         meta:'Tropical river · Blackwood mount',       desc:'Dark iridescent cichlid — a stand-out trophy from northern waters. ' + STD_DESC },
  { id:'p-sooty',    name:'Sooty Grunter',        cat:'freshwater',price:425, size:'52 × 26 cm', pimg:'sooty',     image:IMG+'cod.png',       badge:'New',        meta:'Tropical highland streams · Ironbark mount', desc:'Brawler of the tropical headwaters — solid build, deep charcoal flank. ' + STD_DESC },
